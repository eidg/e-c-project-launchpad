...
const PromptEditor = ({ open, onClose, onSave, name: initialName = "", content: initialContent = "", title = "Edit Prompt", confirmLabel = "Update" }) => {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "prose max-w-none min-h-[220px] border border-gray-300 rounded-md p-3 focus:outline-none",
      },
    },
  });
